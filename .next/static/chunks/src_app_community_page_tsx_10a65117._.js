(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_community_page_tsx_10a65117._.js", {
...
function CommunityPage() {
    ...
    const [sortMethod, setSortMethod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('recent');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CommunityPage.useEffect": ()=>{
            if (error) {
                ...
                }["CommunityPage.useEffect.timer"], 5000);
                return ({
    ...
    const fetchUserLikedPosts = async ()=>{
        if (!username) return;
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])('/users/liked-posts/');
    ...
    const fetchPosts = async (reset = true)=>{
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/posts/?sort_by=${sortMethod}&page=${currentPage}`);
            if (reset) {
    ...
    const goToPage = (pageNumber)=>{
        if (pageNumber !== page && !loading && !loadingMore) {
            ...
            try {
                setLoading(true);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/posts/?sort_by=${sortMethod}&page=${pageNumber}`).then((response)=>{
                    setPosts(response.posts);
                    setHasMorePosts(response.pagination.page < response.pagination.pages - 1);
                    setTotalPages(response.pagination.pages);
                }).catch((err)=>{
    ...
    const renderPaginationItems = ()=>{
        ...
        items.push(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            onClick: ()=>goToPage(0),
        ...
        if (startPage > 1) {
            items.push(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: "px-2",
                children: "..."
            }, "ellipsis1", false, {
                fileName: "[project]/src/app/community/page.tsx",
    ...
    const handleSortMethodChange = (method)=>{
        if (method !== sortMethod) {
            ...
            setPage(0);
            setLoading(true);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/posts/?sort_by=${method}&page=0`).then((response)=>{
                setPosts(response.posts);
                setHasMorePosts(response.pagination.page < response.pagination.pages - 1);
                setTotalPages(response.pagination.pages);
            }).catch((err)=>{
    ...
    const handleUpload = async (event)=>{
        ...
        try {
            ...
            setError(null);
            // Get the auth token
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuthToken"])();
            if (!token) {
    ...
    const handleLike = async (postId)=>{
        ...
        try {
            ...
            // Make API request
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(endpoint, {
                method: 'POST'
            });
            if (!response) {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                children: [
                                                                    likedPosts.includes(post.id) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                                        xmlns: "http://www.w3.org/2000/svg",
                                                                        viewBox: "0 0 24 24",
                                                                        fill: "currentColor",
...
_s(CommunityPage, "zgz/78QGvvTdlxtOYLaVCgGNIno=", false, function() {
    return [
