      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">Figart AI</h3>
              <p className="text-gray-300">
                A platform for photography enthusiasts to learn, share, and grow their skills.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/tutorial" className="text-gray-300 hover:text-white transition">Tutorials</Link></li>
                <li><Link href="/community" className="text-gray-300 hover:text-white transition">Community</Link></li>
                <li><Link href="/ai" className="text-gray-300 hover:text-white transition">AI Tools</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Contact</h3>
              <p className="text-gray-300">
                Have questions or feedback? Reach out to us at <a href="mailto:info@figart-ai.com" className="underline">info@figart-ai.com</a>.
              </p>
            </div>
          </div>
          <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
            <p>© {new Date().getFullYear()} Figart AI. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </main>
